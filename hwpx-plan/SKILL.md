...
| ㅇ 중항목 | 14pt 휴먼명조 | 좌여백 800, **위 여백 5pt(□→ㅇ)** |
| - 세부 | 14pt 휴먼명조 | 좌여백 1400, **위 여백 3pt(ㅇ→-)** |
| ①②③ 열거 | 14pt 휴먼명조 | 좌여백 800 |
| * / ※ 각주 | 12pt 휴먼명조 회색 | 좌여백 2000 |
| 본문 기본 | 14pt 휴먼명조 | JUSTIFY |
...
- **왼쪽정렬 원칙**: 첫째 줄과 줄바꿈된 줄이 **같은 왼쪽 위치**에서 시작(intent=0, 내어쓰기 없음). 레벨 들여쓰기는 왼쪽 여백(left)으로만.
