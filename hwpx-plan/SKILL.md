...
| ㅇ 중항목 | 14pt 휴먼명조 | 좌여백 800 · 내어쓰기 -2100, **위 5pt(□→ㅇ)** |
| - 세부 | 14pt 휴먼명조 | 좌여백 1400 · 내어쓰기 -1400, **위 3pt(ㅇ→-)** |
| ①②③ 열거 | 14pt 휴먼명조 | 좌여백 800 · 내어쓰기 -2100 |
| * / ※ 각주 | 12pt 휴먼명조 회색 | 좌여백 2000 · 내어쓰기 -1400 |
| 본문 기본 | 14pt 휴먼명조 | 왼쪽정렬 |
...
- **왼쪽정렬 + 내어쓰기(hanging)**: 첫 줄은 기호(□/ㅇ/-)가 왼쪽으로 나오고, **줄바꿈된 줄은 본문 텍스트 위치(left)에 맞춰 정렬**. 검토본(reviedplan_v3) 실측값(ㅇ left800/intent-2100, - left1400/intent-1400).
